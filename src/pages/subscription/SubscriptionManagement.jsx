...
const SubscriptionManagement = () => {
    ...
    <div className="row g-4 align-items-stretch justify-content-center">
      ...
      <div className="col-lg-4 col-md-6">
        <div className="card-box">
          ...
          <div className="rounded-4 p-4 mt-auto" style={{ backgroundColor: "#EAECEF" }}>
            ...
            <ul className="list-unstyled m-0 d-flex flex-column gap-3">
              {FREE_BENEFITS.map((item, index) => (
                <li key={index} className="d-flex align-items-center gap-2 text-secondary small fw-bold">
      ...
      <div className="col-lg-6 col-md-6">
        <div className="card-box highlight-border justify-content-center text-center p-8">

          <div className="mb-8">
            <h3 className="fw-bold mb-8">解鎖完整陪伴功能</h3>
            <p className="text-secondary mx-auto small mb-4" style={{ maxWidth: "100%", lineHeight: "1.6" }}>
          ...
          <div className="row g-3 mb-11 text-start px-2">
            {UPGRADE_BENEFITS.map((item, index) => (
              <div key={index} className="col-lg-6 d-flex align-items-start gap-3">
                <IconCheck size={18} className="flex-shrink-0" style={{ color: "#398C9F", strokeWidth: 3 }} />
                <span className="text-secondary small fw-bold" style={{ lineHeight: "1.8", fontSize: "0.85rem" }}>
                  {item}
                </span>
              </div>
            ))}
        ...
        <div className="card-box">
          ...
          <div className="subscription-details mb-4 flex-grow-1">
            <div className="info-row">
              ...
              <span className="value">2026/02/07 ~ 2026/03/07</span>
            </div>
            <div className="info-row">
              <span className="label">下次扣款日期</span>
              <span className="value">2026/03/08</span>
            </div>
            <div className="info-row">
              <span className="label">付款方式</span>
              <span className="value d-flex align-items-center gap-2">
                <IconCreditCard size={20} color="#398C9F" /> 信用卡 Visa (•••• 4242)
              </span>
            </div>
            <div className="info-row">
          ...
          <div className="d-flex gap-3">
            ...
            <button className="btn btn-outline-gray rounded-pill py-2 w-100">
              變更付款信用卡
            </button>
          </div>
        </div>
      ...
      <div className="col-lg-3 col-md-6">
        <div className="card-box d-flex flex-column">
          ...
          <div className="border rounded-4 p-5 mb-3">
            ...
            <div className="fs-5 fw-bold text-primary-teal mb-3" style={{ color: "#398C9F" }}>NT$ 1,990 / 年</div>
  ...
  const renderFeatureList = (isActive) => (
    <ul className="list-unstyled m-0 d-flex flex-column gap-3">
      <li className="list-item">
        <IconCheck size={20} className={isActive ? "icon-check active" : "icon-check"} />
        語音內容庫：{isActive ? "全庫解鎖" : "可試聽免費專區"}
      </li>
      <li className="list-item">
        <IconCheck size={20} className={isActive ? "icon-check active" : "icon-check"} />
        播放器：{isActive ? "建立專屬清單" : "基礎功能 (需手動切換)"}
      </li>
      <li className="list-item">
        <IconCheck size={20} className={isActive ? "icon-check active" : "icon-check"} />
        心情日記：{isActive ? "無限篇數、完整紀錄" : "體驗版 (上限 3 篇)"}
      </li>
      <li className="list-item">
        <IconCheck size={20} className={isActive ? "icon-check active" : "icon-check"} />
        情緒儀表板：{isActive ? "趨勢分析 / 月曆回顧" : "僅查看當日狀態"}
      </li>
    </ul>
  );

  return (
    <div className="bg-liner subscription-management-container py-5">
      <div className="container">
        <h2 className="management-title text-primary-05">我的訂閱狀態</h2>
        {isPro ? renderProView() : renderFreeView()}

        <div className="text-center mt-10 mb-1 text-muted small d-flex align-items-center justify-content-center gap-1">
          <button
